...
export function ActionCard({ title, subtitle, icon, bgClass }: ActionCardProps) {
  return (
    <button className="flex-1 bg-white border border-slate-200 rounded-2xl p-2 flex items-center justify-start shadow-sm hover:shadow-md transition-shadow group text-right">
