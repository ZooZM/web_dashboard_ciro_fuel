    ...
    <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm">
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-blue-50 flex items-center justify-center">
            <img src="/orderPage/orderDetails/invoice.svg" alt="" className="w-5 h-5 text-blue-600" />
          </div>
      ...
      <div className="grid grid-cols-2 gap-4 mb-8 px-2">
          <div className="flex items-center justify-start gap-4">
            <div className="w-12 h-12 rounded-xl bg-emerald-50 flex items-center justify-center shrink-0 border border-emerald-100">
              <img src="/orderPage/orderDetails/gunStation.svg" alt="" className="w-6 h-6" />
            </div>
          ...
          <div className="flex items-center justify-start gap-4">
            <div className="w-12 h-12 rounded-xl bg-emerald-50 flex items-center justify-center shrink-0 border border-emerald-100">
              <img src="/orderPage/orderDetails/station.svg" alt="" className="w-6 h-6" />
            </div>
            <div className="flex flex-col text-right">
      ...
      <div className="flex flex-col gap-3 px-2">
          <div className="flex items-center gap-2">
            <img src="/orderPage/orderDetails/comment.svg" alt="" className="w-4 h-4 opacity-50" />
