  ...
  return (
    <div className="flex flex-col flex-1 text-right font-sans bg-[#F8FAFC] -mt-4 border border-[#E7E9EF] rounded-2xl min-h-full p-6" dir="rtl">
      ...
      <div className="pb-4 shrink-0 flex justify-start">
        <div className="inline-flex items-center gap-2 px-5 py-2.5 text-[13.5px] text-slate-600 cursor-pointer">
          ...
          <div className="flex justify-between items-center px-8 pt-8 pb-6">
            ...
            <div className='flex gap-2 items-center'>
              ...
              <button
                ...
                className="flex bg-white items-center gap-2.5 px-2.5 py-2.5 border border-slate-200 rounded-xl text-[13px] font-medium text-slate-500 hover:bg-slate-50 transition-colors"
              >
                {isMuted ? (
