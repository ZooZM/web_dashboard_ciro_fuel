interface AdminPetrolCompaniesStatsProps {
  activeTab: 'companies' | 'owners' | 'stations';
}

export function AdminPetrolCompaniesStats({ activeTab }: AdminPetrolCompaniesStatsProps) {
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm flex items-center gap-4 justify-start">
          ...
          <div className="flex flex-col text-right">
            <span className="text-sm font-bold text-slate-500 mb-1">إجمالي الشركات</span>
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm flex items-center gap-4 justify-start">
          <div className="w-12 h-12 rounded-full bg-orange-50 flex items-center justify-center shrink-0">
            <img src="/Admin/Brands/group.svg" alt="" className="w-6 h-6" />
          </div>
          <div className="flex flex-col text-right">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm flex items-center gap-4  justify-start">
          ...
          <div className="flex flex-col text-right">
            ...
            <span className="text-2xl font-black text-slate-900">97</span>
          </div>
        </div>
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm flex items-center gap-4 justify-start">
          ...
          <div className="flex flex-col text-right">
            <span className="text-sm font-bold text-slate-500 mb-1">طلبات هذا الشهر</span>
  ...
  // Owners and Stations tabs share the same stats
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
