    ...
    <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm">
      ...
      <div className="grid grid-cols-2 gap-y-8  mb-8 border-b border-slate-100 pb-8 px-2">
          ...
          <div className="flex flex-col gap-1 text-right">
            <span className="text-slate-400 text-xs font-bold">الكمية</span>
            <div className="flex items-center gap-1.5 flex-wrap">
              <span className="text-[#162155] text-base font-black">20,000 لتر</span>
              <span className="text-slate-300 font-bold text-lg">+</span>
              <span className="text-[#162155] text-base font-black">589.26 لتر</span>
            </div>
          </div>
          <div className="flex flex-col gap-1 text-right">
            <span className="text-slate-400 text-xs font-bold">العمولة لكل لتر</span>
            <span className="text-[#162155] text-base font-black">0.13 ر.س / لتر</span>
          </div>
          {/* Row 2 */}
          <div className="flex flex-col gap-1 text-right">
            <span className="text-slate-400 text-xs font-bold">المحطة</span>
            <span className="text-[#162155] text-base font-black">جدة - الرحاب</span>
          </div>
          <div className="flex flex-col gap-1 text-right">
            <span className="text-slate-400 text-xs font-bold">نوع الوقود</span>
            <span className="text-[#162155] text-base font-black">بنزين 95</span>
          </div>
      </div>
      ...
      <div className="flex flex-col gap-3 px-2">
        <div className="flex items-center gap-2">
          <img src="/transportCompany/orderPage/orderDetails/comment.svg" alt="" className="w-4 h-4  " />
