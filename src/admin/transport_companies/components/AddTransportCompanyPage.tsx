  ...
  return (
    <div className="w-full h-full min-h-full flex flex-col p-4 md:p-6 font-sans bg-[#F8FAFC] border border-[#E7E9EF] rounded-2xl" dir="rtl">
      ...
      <div className="flex flex-col gap-1 mb-8 text-right">
        <h1 className="text-2xl font-black text-[#162155]">إضافة شركة ناقلة</h1>
        <p className="text-sm font-bold text-[#858C95]">
      ...
      <div className="flex flex-col lg:flex-row gap-6 items-stretch flex-1">
        ...
        <div className="flex-1 w-full bg-white border border-[#E7E9EF] rounded-2xl p-6 md:p-8 shadow-sm flex flex-col">
          {/* Section Header */}
          <div className="flex items-center justify-start gap-2 mb-8 shrink-0">
            ...
            <h2 className="text-xl font-black text-[#162155]">بيانات الحساب</h2>
          </div>
          ...
          <div className="flex flex-col gap-6 flex-1 text-right">
              ...
              <div className="flex-1 flex flex-row gap-6">
                ...
                <div className='flex w-full mt-3 flex-col'>
                  ...
                  <input 
                    ...
                    className="w-full px-4 py-3 bg-white border border-[#E7E9EF] rounded-xl text-sm font-medium focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-right">
              <div className="flex flex-col">
                ...
                <input 
                  ...
                  className="w-full px-4 py-3 bg-white border border-[#E7E9EF] rounded-xl text-sm font-medium focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 text-left"
                  dir="ltr"
                />
              </div>
              <div className="flex flex-col">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-right">
              <div className="flex flex-col">
                ...
                <div className="flex items-center w-full h-[46px] border border-[#E7E9EF] rounded-xl overflow-hidden focus-within:border-blue-500 focus-within:ring-1 focus-within:ring-blue-500 transition-colors bg-white">
                  ...
                  <div className="flex items-center justify-center px-4 gap-2 h-full border-r border-[#E7E9EF] shrink-0">
            ...
            <div className="flex flex-col">
              <textarea 
                ...
                className="w-full px-4 py-3 bg-white border border-[#E7E9EF] rounded-xl text-sm font-medium focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 resize-none"
              ></textarea>
            </div>
          ...
          <div className="mt-8 shrink-0">
            ...
            <div className="flex items-center justify-end gap-4">
              <button 
                ...
                className="bg-white text-slate-600 border border-[#E7E9EF] px-8 py-3 rounded-xl text-sm font-bold hover:bg-slate-50 transition-colors shadow-sm"
              >
                إلغاء
              </button>
        ...
        <div className="w-full lg:w-[350px] flex flex-col gap-6 shrink-0 h-full">
          ...
          <div className="bg-white border border-[#E7E9EF] rounded-2xl p-6 shadow-sm">
            <div className="flex items-center justify-start gap-2 mb-6">
              ...
              <h3 className="text-base font-black text-[#162155]">ملخص الحساب</h3>
            </div>
            
            <div className="flex flex-col gap-4 text-center">
              <div className="flex flex-col items-center">
                <span className="text-base font-black text-[#162155] mb-1">اسم الشركة</span>
                <span className="text-xs font-bold text-slate-400">المدينة</span>
              </div>
              
              <div className="h-px bg-[#E7E9EF] w-full my-1"></div>
              
              <div className="flex items-center justify-between">
                <span className="text-sm font-black text-[#162155]" dir="ltr">920-xxxxxx</span>
              ...
              <div className="flex items-center justify-between">
                <span className="text-sm font-black text-[#162155]">-</span>
          ...
          {/* Next Steps */}
          <div className="bg-white border border-[#E7E9EF] rounded-2xl p-6 shadow-sm flex-1">
            <div className="flex items-center justify-start gap-2 mb-6">
              <div className="w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center">
                <img src="/petrolCompany/transporters/addTransporter/detail.svg" alt="" className="w-4 h-4" />
              </div>
              <h3 className="text-base font-black text-[#162155]">الخطوات التالية بعد الإنشاء</h3>
            </div>
            ...
            <div className="flex flex-col gap-6 relative">
              ...
              <div className="flex items-start gap-4 relative z-10 text-right">
                ...
                <div className="flex flex-col">
                  <span className="text-sm font-black text-[#162155] mb-1">إرسال رمز تفعيل للمسؤول</span>
              ...
              <div className="flex items-start gap-4 relative z-10 text-right">
                ...
                <div className="flex flex-col">
                  <span className="text-sm font-black text-[#162155] mb-1">إضافة ملاك المحطات</span>
                  <span className="text-[10px] font-bold text-slate-400 leading-relaxed">
              ...
              <div className="flex items-start gap-4 relative z-10 text-right">
                ...
                <div className="flex flex-col">
                  <span className="text-sm font-black text-[#162155] mb-1">ربط شركات النقل</span>
                  <span className="text-[10px] font-bold text-slate-400 leading-relaxed">
              ...
              <div className="flex items-start gap-4 relative z-10 text-right">
                ...
                <div className="flex flex-col">
                  <span className="text-sm font-black text-[#162155] mb-1">استقبال الطلبات</span>
                  <span className="text-[10px] font-bold text-slate-400 leading-relaxed">
