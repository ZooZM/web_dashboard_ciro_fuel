...
import { MapTrackingCard }    from '@/features/home/components/MapTrackingCard';
import { NewOrdersCard }      from '@/features/home/components/NewOrdersCard';
import { ProgressOrdersCard } from '@/features/home/components/ProgressOrdersCard';
import { ActionCard }         from '@/features/home/components/ActionCard';
import { InvoicesSection }    from '@/features/home/components/InvoicesSection';
import { DoughnutSection }    from '@/features/home/components/DoughnutSection';
...
const ACTION_CARDS = [
  { title: 'عرض الفواتير',      subtitle: 'الفواتير و المستحقات',    icon: '/home/invoice.svg',  bgClass: 'bg-[#F3E8FF] border border-[#E9D5FF]' },
  { title: 'تحديث أجرة النقل', subtitle: 'تحديث تسعيرة المناطق',    icon: '/home/location.svg', bgClass: 'bg-[#FEE2E2] border border-[#FECACA]' },
  { title: 'إضافة سائق',        subtitle: 'إضافة سائق جديد',         icon: '/home/users.svg',    bgClass: 'bg-[#DBEAFE] border border-[#BFDBFE]' },
  { title: 'إسناد طلب جديد',    subtitle: 'تعيين سائق و مركبة',       icon: '/home/user.svg',     bgClass: 'bg-[#D1FAE5] border border-[#A7F3D0]' },
];
    ...
    <div className="w-full p-4 md:p-6 flex-1 -mt-4 bg-[#F8FAFC] border border-[#E7E9EF] rounded-2xl min-h-full font-sans" dir="rtl">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="flex items-center gap-3 bg-white border border-slate-200 rounded-xl px-4 py-2.5 shadow-sm cursor-pointer hover:bg-slate-50 transition-colors">
            <img src="/home/date.svg" className="w-4 h-4 opacity-70" />
