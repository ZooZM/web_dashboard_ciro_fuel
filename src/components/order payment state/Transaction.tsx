                ...
                <div className="flex items-center gap-3">
                    <div className=" w-[56px] h-[56px] rounded-2xl bg-[#1E5FFF] flex items-center justify-center shrink-0">
                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M33.3327 23.3333L6.66602 23.3333L16.666 33.3333" stroke="#E7EEFF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M6.66602 16.6667H33.3327L23.3327 6.66675" stroke="#E7EEFF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                    </div>
                        ...
                        <div className="mb-2">
                            ...
                            <div className="flex flex-row gap-2 ">
                                ...
                                <div className='flex flex-row items-center gap-2 bg-green-100 px-2 py-1 rounded-lg'>
                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M5.33333 10.6667L10.6667 5.33333M14 8C14 11.3137 11.3137 14 8 14C4.68629 14 2 11.3137 2 8C2 4.68629 4.68629 2 8 2C11.3137 2 14 4.68629 14 8ZM11.3333 10C11.3333 10.7364 10.7364 11.3333 10 11.3333C9.26362 11.3333 8.66667 10.7364 8.66667 10C8.66667 9.26362 9.26362 8.66667 10 8.66667C10.7364 8.66667 11.3333 9.26362 11.3333 10ZM7.33333 6C7.33333 6.73638 6.73638 7.33333 6 7.33333C5.26362 7.33333 4.66667 6.73638 4.66667 6C4.66667 5.26362 5.26362 4.66667 6 4.66667C6.73638 4.66667 7.33333 5.26362 7.33333 6Z" stroke="#0E8A44" stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
