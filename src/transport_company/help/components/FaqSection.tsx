    ...
    <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm flex flex-col gap-6">
      ...
      <div className="flex items-center gap-2 w-full">
        <div className="w-10 h-10 rounded-xl bg-orange-50 flex items-center justify-center">
          <img src="/transportCompany/HelpPage/questionMark.svg" className="w-5 h-5 object-contain" alt="" />
        </div>
      ...
      <div className="flex flex-col gap-4">
        ...
        <FaqAccordionItem  title="طلبيات الوقود" icon="/transportCompany/HelpPage/station.svg">
          {/* Question 1 */}
        ...
        <FaqAccordionItem title="تأخير التوصيل" icon="/transportCompany/HelpPage/truck.svg">
          <div className="flex flex-col gap-2 text-right">
        ...
        <FaqAccordionItem title="طرق الدفع" icon="/transportCompany/HelpPage/payment.svg">
          <div className="flex flex-col gap-2 text-right">
        ...
        <FaqAccordionItem title="الحساب و تسجيل الدخول" icon="/transportCompany/HelpPage/user.svg">
          <div className="flex flex-col gap-2 text-right">
