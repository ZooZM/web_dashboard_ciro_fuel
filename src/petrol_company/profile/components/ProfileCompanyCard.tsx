      ...
      <div className="flex flex-col gap-6 mt-2">
        ...
        <div className="grid grid-cols-2 gap-4 w-full">
          ...
          <div className="flex flex-col gap-2 text-right">
            ...
            {!isEditing ? (
              <span className="text-[#162155] font-black text-sm">شركة بترو أمان</span>
            ) : (
              <input 
                type="text" 
                defaultValue="شركة بترو أمان"
        ...
        <div className="grid grid-cols-2 gap-4 w-full">
          ...
          <div className="flex flex-col gap-2  text-right items-center">
            ...
            <span className="text-[#162155] font-black text-sm text-end w-full" dir="ltr">PC-2024-001</span>
          </div>
        </div>
      </div>
    </div>
